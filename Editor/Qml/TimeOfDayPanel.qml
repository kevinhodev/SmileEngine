        ...
        Column {
            ...
            Card {
                ...
                SliderRow {
                    ...
                    valueText: Math.round(todModel.curtainAmount * 100) + "%"
                    from: 0; to: 1
                    boundValue: todModel.curtainAmount
                    onMoved: v => todModel.curtainAmount = v
                }
                // F4: chuva escurece sol/ambient, sobe cobertura de nuvem e engrossa o fog
                Item {
                    width: parent.width
                    height: 22
                    enabled: todModel.rainAmount > 0
                    ...
                    Toggle {
                        anchors.right: parent.right
                        anchors.verticalCenter: parent.verticalCenter
                        checked: todModel.weatherDriveSky
