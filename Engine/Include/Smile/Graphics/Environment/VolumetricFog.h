...
#include "Smile/Graphics/GI/DDGI.h" // FDDGICascadeConstants: bloco comum aos cinco cbuffers
#include <d3d12.h>
...
namespace Smile {
    ...
    public:
        ...
        EHistoryTarget HistoryTargets() const override { return EHistoryTarget::VolumetricFog; }
        void OnInvalidateHistory(EHistoryTarget) override { ResetHistory(); }
